...
Histogram identifies, that in our data set exists distribution distorting values.
...
There is visible difference on the left side of the histogram. This change 
...
Data for quality control was separated into case (65) and control (32). Our main
 goal is to check if there exists distortions in methylation data.
...
mostly normal and there is no need for data removal.
...
![QC plot](./11.png)
PlotQC demonstrates, that in our data set bad samples does not exist.
