...
![First correlation outliers elimination histogram.](./1.png)
...
![Outlier identification in present data set.](./2.png)
...
![Second correlation outliers elimination histogram.](./3.png)
...
![Outlier identification in recalculated data set.](./4.png)
...
![Control samples pair-to-pair correlation histogram](./5.png)
...
![Control samples scatter plot](./7.png)
...
![Case samples pair-to-pair correlation histogram](./6.png)
...
![Case samples scatter plot](./8.png)
...
![Bipolar samples scatter plot](./9.png)
...
![Schizophrenia samples scatterplot](./10.png)
