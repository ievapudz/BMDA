...
There is a visible difference on the left side of the histogram (Figure 2). This 
change indicated that we correctly removed distorting values.
...
distorted values in respect of all case samples mean. 
...
The scatter plot (Figure 4) demonstrates two outliers in standard deviation from 
methylation
...
because no large deviations are visible from the rest of samples. Also 
