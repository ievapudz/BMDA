...
6.1. Were there any other reports (not lethal) of folligen solution therapy?
6.2. What are other symptoms caused by "Exemption 4"?
6.3. Which gender uses product "Exemption 4" more?
6.4. Which age group uses "Exemption 4" the most?
...
pie(c(product_freq[1], product_freq[2], other), 
    labels=c(label_1, label_2, 'Other products'), 
    main="Products reported with death included as outcome")
```
