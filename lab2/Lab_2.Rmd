...
The case groups are denoted by colours: pink (control), blue (bipolar), and red
(schizophrenia).
...
marked with blue colour. Due to such imbalance, clusterisation 
...
heatmap_colors <- c('#838B8B', '#FFFFFF', '#FF6A6A')
