...
After all gene name manipulations there were selected 10686 foreground genes
with FDR correction and unique names and 27304 background genes with unique
names.

For gene ontology enrichmet analysis on statistically significant positions
we used GOrilla tool. In terms of processes, the highest enrichment is found
in a few main process categories: regulation of metabolic process, developmental
process and positive regulations of biological processes. (Need more) In component part,
...
The histogram of p-values (Figure 19) extracted from performed ANOVA test showed 
...
Because the Manhattan plot in sex-based hypothesis testing was uset on
7 chromosome, for the more detailed comparison, in the age-based test 
we also plotted Manhattan plot (Figure 17) with p-values of positions 
this chromosome.
...
The volcano plot shows 4 outliers that are downregulated in samples with age
younger than 47 years old and 1 outlier in samples with age older than 47 years old.
...
\begin{figure}[!h]
  \begin{center}
    ...
    \caption{
     ...
     grouped to people younger than 47 years and older than 47. 
    }
  \end{center}
\end{figure}
