...
The volcano plot was drawn for chromosome 7th due to the same reason it was 
chosen to for the Manhattan plot.
...
\begin{figure}[!h]
  \begin{center}
    ...
    \caption{
    Components with the highest enrichment according to foreground and 
    background genes in GOrilla tool
    }
  \end{center}
\end{figure}
...
apparent in the GOrilla output (Figure 22). Additionally, there is a nucleotide
...
As Manhattan plot, the volcano plot of age-based test was also plotted for 7th 
chromosome for further comparison.
