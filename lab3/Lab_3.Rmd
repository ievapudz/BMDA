...
to define these groups based on: sex, age, and diagnosis type.
...
After all manipulations of gene names there were selected 10686 foreground genes
...
apparent in the GO output (Figure 21). Additionally, there is a nucleotide
