...
For gene ontology enrichment analysis on statistically significant positions
...
apparent in the GO output (Figure 22). Additionally, there is a nucleotide
binding seen in the scheme, which eventually leads to binding ATP function
(not included in the figure). Recent studies [@inoue2022role] investigate the 
