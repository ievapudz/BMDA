...
Few examples of predicted age (Table 3) indicate that ages around 40-50 are
guessed more correctly than younger ones. This is quite understandable 
given that most sample ages are distributed in this range. An interesting
...
The output of principal component analysis (Figure 26) was the first principal 
...
based on t-test that was run for groups of sex (Figure 28) confirmed that groups 
...
Additionally, there was analysis run with respect of sample donors' age. 
...
(Figure 29) of PCA using only the subset of positions showed that groups 23-40 
...
However, after taking into account all positions (Figure 30), the output of PCA 
...
age representatives, PCA for two age groups (23-46, 47-77) was run (Figure 31).
...
tendencies of sample scores in the PCA plot (Figure 31 and Figure 32).
...
positions to distinguish groups of age (Figure 33). Nevertheless, the principal components
...
after ANOVA (Figure 25). PCA (Figure 34) did not distinguish these groups 
markedly.
