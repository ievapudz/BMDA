...
train_data <- matrix(1:20, nrow=10, ncol=2)
train_data[1, 1] <- 5
train_data[1, 2] <- 12
labels <- c(10, 12, 13, 24, 15, 16, 17, 19, 20, 22)
...
knn_inference <- function(k, train_data, labels, point) {
 ...
 for(i in 1:nrow(train_data)) {   
  ...
  for(j in 1:ncol(train_data)) {
    distance <- distance + (point[j] - train_data[i, j])**2
  }
...
print(knn_inference(3, train_data, labels, point))
