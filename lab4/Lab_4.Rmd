...
# The line below should return a vector of TRUE and FALSE to indicate which
...
ggbiplot(beta.pca.avo_age_ps, ellipse=TRUE, obs.scale=1, var.scale=1,
         var.axes=FALSE,
         groups=age_groups) +
         ggtitle("PCA for groups of age including statistically significant positions")
```
...
ggbiplot(beta.pca.avo_age_ps, ellipse=TRUE, obs.scale=1, var.scale=1,
         var.axes=FALSE,
         groups=age_groups_2) +
         ggtitle("PCA for two groups of age including statistically significant positions")
```
