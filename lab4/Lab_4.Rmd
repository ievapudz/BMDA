...
(Figure 28) of PCA using only the subset of positions showed that groups 23-40 
...
However, after taking into account all positions (Figure 29), the output of PCA 
...
tendencies of sample scores in the PCA plot (Figure 30 and Figure 31).
